...
export default function ActivityList() {
    ...
    const { state, dispatch, scrollToSection, categoryName, isEmptyActivities } = useActivity()

  return (
    <>
        <h2 className="texdt-3xl font-bold text-slate-600 text-center">Comida y Actividades</h2>
